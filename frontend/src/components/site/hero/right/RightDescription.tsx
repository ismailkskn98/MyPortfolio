...
const RightDescription = () => {
  return (
    <div id="rightDescription" className="w-full md:max-w-[800px] flex flex-col gap-4">
      ...
      <p className="px-6 text-White para-m">Harika web deneyimleri oluşturarak işletmelerin büyümesine yardımcı oluyorum. Eğer iş bitirmeyi seven bir geliştirici arıyorsanız,</p>
      <p className="code-m text-Brand2">{"</p>"}</p>
