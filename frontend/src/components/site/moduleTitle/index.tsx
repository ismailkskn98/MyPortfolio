...
const ModuleTitle: React.FC<Props> = ({ description, title, isHome }) => {
  return (
    <motion.article
      ...
      className={`flex flex-col items-center text-White ${isHome ? "gap-10" : "gap-0"}`}
    >
      <div className={`flex-col items-center gap-4 max-h-[140px] ${isHome ? "hidden md:flex" : "hidden"}`}>
      ...
      <div className="flex flex-col items-center gap-4">
        <div className="flex flex-col items-center gap-4">
          ...
          <Image src={LineTitle} alt="moduleTitle arrow" className="max-h-[40px]" width={15} height={40} />
        </div>
